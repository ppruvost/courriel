...
L’application Courriel Render utilise l’API Gmail uniquement pour accéder au contenu de la boîte mail de l’utilisateur 
dans l'intention de lire ou envoyer des e-mails via un serveur privé.
